...
alias integrationTestAuth="flutter drive --target=test_driver/auth/reg/app.dart --no-sound-null-safety"

# flutter drive --target=test_driver/auth/reg/app.dart --no-sound-null-safety
