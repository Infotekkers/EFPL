...
EFPLStatsDto _$EFPLStatsDtoFromJson(Map<String, dynamic> json) {
  return _EFPLStatsDto.fromJson(json);
}

/// @nodoc
class _$EFPLStatsDtoTearOff {
  const _$EFPLStatsDtoTearOff();

  _EFPLStatsDto call(
      {required int highestPoint,
      required int averagePoint,
      required List<dynamic> mostSelectedPlayer,
      required List<dynamic> mostTransferredOutPlayer,
      required int transfersMadeCount,
      required List<dynamic> mostCaptainedPlayer,
      required List<dynamic> mostViceCaptainedPlayer,
  ...
  EFPLStatsDto fromJson(Map<String, Object?> json) {
    return EFPLStatsDto.fromJson(json);
  }
}

/// @nodoc
const $EFPLStatsDto = _$EFPLStatsDtoTearOff();

/// @nodoc
mixin _$EFPLStatsDto {
  int get highestPoint => throw _privateConstructorUsedError;
  int get averagePoint => throw _privateConstructorUsedError;
  List<dynamic> get mostSelectedPlayer => throw _privateConstructorUsedError;
  List<dynamic> get mostTransferredOutPlayer =>
      throw _privateConstructorUsedError;
  int get transfersMadeCount => throw _privateConstructorUsedError;
  List<dynamic> get mostCaptainedPlayer => throw _privateConstructorUsedError;
  List<dynamic> get mostViceCaptainedPlayer =>
      throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $EFPLStatsDtoCopyWith<EFPLStatsDto> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $EFPLStatsDtoCopyWith<$Res> {
  factory $EFPLStatsDtoCopyWith(
          EFPLStatsDto value, $Res Function(EFPLStatsDto) then) =
      _$EFPLStatsDtoCopyWithImpl<$Res>;
  $Res call(
      {int highestPoint,
      int averagePoint,
      List<dynamic> mostSelectedPlayer,
      List<dynamic> mostTransferredOutPlayer,
      int transfersMadeCount,
      List<dynamic> mostCaptainedPlayer,
      List<dynamic> mostViceCaptainedPlayer,
      int benchBoostCount,
      int freeHitCount,
      int wildCardCount,
...
/// @nodoc
class _$EFPLStatsDtoCopyWithImpl<$Res> implements $EFPLStatsDtoCopyWith<$Res> {
  _$EFPLStatsDtoCopyWithImpl(this._value, this._then);

  final EFPLStatsDto _value;
  // ignore: unused_field
  final $Res Function(EFPLStatsDto) _then;
...
/// @nodoc
abstract class _$EFPLStatsDtoCopyWith<$Res>
    implements $EFPLStatsDtoCopyWith<$Res> {
  factory _$EFPLStatsDtoCopyWith(
          _EFPLStatsDto value, $Res Function(_EFPLStatsDto) then) =
      __$EFPLStatsDtoCopyWithImpl<$Res>;
  @override
  $Res call(
      {int highestPoint,
      int averagePoint,
...
/// @nodoc
class __$EFPLStatsDtoCopyWithImpl<$Res> extends _$EFPLStatsDtoCopyWithImpl<$Res>
    implements _$EFPLStatsDtoCopyWith<$Res> {
  __$EFPLStatsDtoCopyWithImpl(
      _EFPLStatsDto _value, $Res Function(_EFPLStatsDto) _then)
      : super(_value, (v) => _then(v as _EFPLStatsDto));

  @override
  _EFPLStatsDto get _value => super._value as _EFPLStatsDto;
...
/// @nodoc
@JsonSerializable()
class _$_EFPLStatsDto extends _EFPLStatsDto {
  const _$_EFPLStatsDto(
  ...
  @override
  final List<dynamic> mostSelectedPlayer;
  @override
  final List<dynamic> mostTransferredOutPlayer;
  @override
  final int transfersMadeCount;
  @override
  final List<dynamic> mostCaptainedPlayer;
  @override
  final List<dynamic> mostViceCaptainedPlayer;
  @override
  ...
  _$EFPLStatsDtoCopyWith<_EFPLStatsDto> get copyWith =>
      __$EFPLStatsDtoCopyWithImpl<_EFPLStatsDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_EFPLStatsDtoToJson(this);
  }
}

abstract class _EFPLStatsDto extends EFPLStatsDto {
  const factory _EFPLStatsDto(
      {required int highestPoint,
      required int averagePoint,
      required List<dynamic> mostSelectedPlayer,
      required List<dynamic> mostTransferredOutPlayer,
  ...
  @override
  List<dynamic> get mostSelectedPlayer;
  @override
  List<dynamic> get mostTransferredOutPlayer;
  @override
  int get transfersMadeCount;
  @override
  List<dynamic> get mostCaptainedPlayer;
  @override
  List<dynamic> get mostViceCaptainedPlayer;
  @override
