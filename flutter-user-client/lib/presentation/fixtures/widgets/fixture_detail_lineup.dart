...
class FixtureDetailLineUp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Map<dynamic, dynamic> homeTeamLineUp =
        fixture['fixture']!.homeTeamLineUp.value.fold((l) => {}, (r) => r);

    Map<dynamic, dynamic> awayTeamLineUp =
        fixture['fixture']!.awayTeamLineUp.value.fold((l) => {}, (r) => r);
    return homeTeamLineUp.isEmpty && awayTeamLineUp.isEmpty
        ? const SizedBox(
            height: 350,
            child: Center(
              child: Text(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    homeTeamLineUp['defenders'].length - 1 >=
                                            index
                                        ? homeTeamLineUp['defenders'][index]
                                                ['playerName']
                                            .toString()
                                        : "",
                                  ),
                                  Text(
                                    awayTeamLineUp['defenders'].length - 1 >=
                                            index
                                        ? awayTeamLineUp['defenders'][index]
                                                ['playerName']
                                            .toString()
                                        : "",
                                  ),
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    homeTeamLineUp['midfielders'].length - 1 >=
                                            index
                                        ? homeTeamLineUp['midfielders'][index]
                                                ['playerName']
                                            .toString()
                                        : "",
                                  ),
                                  Text(
                                    awayTeamLineUp['midfielders'].length - 1 >=
                                            index
                                        ? awayTeamLineUp['midfielders'][index]
                                                ['playerName']
                                            .toString()
                                        : "",
                                  ),
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    homeTeamLineUp['strikers'].length - 1 >=
                                            index
                                        ? homeTeamLineUp['strikers'][index]
                                                ['playerName']
                                            .toString()
                                        : "",
                                  ),
                                  Text(
                                    awayTeamLineUp['strikers'].length - 1 >=
                                            index
                                        ? awayTeamLineUp['strikers'][index]
                                                ['playerName']
                                            .toString()
                                        : "",
                                  ),
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    homeTeamLineUp['bench'].length - 1 >= index
                                  ...
                                  Text(
                                    awayTeamLineUp['bench'].length - 1 >= index
...
List<int> getPlayerCount({required Map<String, Fixture> fixture}) {
