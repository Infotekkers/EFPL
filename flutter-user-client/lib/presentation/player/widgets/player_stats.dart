  ...
  Widget build(BuildContext context) {
    return BlocConsumer<PlayerBloc, PlayerState>(
      ...
      builder: (context, state) => state.map(
        ...
        loadSuccess: (state) => _buildDataTable(state),
            ...
            rows: List.generate(state.player.score.length, (index) {
              return DataRow(
                ...
                cells: [
                  ...
                  DataCell(
                    Text(
                        state.player.score[index].minutesPlayed?.getOrCrash() ??
                            ""),
                  ),
                  DataCell(
                  ...
                  DataCell(
                    Text(state.player.score[index].penalitiesMissed
                            ?.getOrCrash() ??
                        ""),
                  ),
                  DataCell(
                    Text(state.player.score[index].penalitiesSaved
                            ?.getOrCrash() ??
                        ""),
                  ),
                  DataCell(
