...
import 'application/auth/auth/auth_bloc.dart' as _i22;
...
import 'application/epl_stats/epl_stats_bloc.dart' as _i23;
import 'application/fixture/fixture_bloc.dart' as _i4;
import 'application/my_team/myteam_bloc.dart' as _i28;
import 'application/player/player_bloc.dart' as _i29;
...
import 'domain/my_team/i_my_team_repository.dart' as _i24;
import 'domain/player/i_player_repository.dart' as _i26;
...
import 'infrastructure/my_team/my_team_repository.dart' as _i25;
import 'infrastructure/player/player_remote_data_provider.dart' as _i13;
import 'infrastructure/player/player_repository.dart' as _i27;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i22.AuthBloc>(() => _i22.AuthBloc(get<_i7.IAuthRepository>()));
  gh.lazySingleton<_i23.EPLStatsBloc>(
      () => _i23.EPLStatsBloc(get<_i9.IEPLStatsRepository>()));
  gh.lazySingleton<_i24.IMyTeamRepository>(() => _i25.MyTeamRepository(
      get<_i11.MyTeamLocalDataProvider>(),
      get<_i12.MyTeamRemoteDataProvider>()));
  gh.lazySingleton<_i26.IPlayerRepository>(
      () => _i27.PlayerRepository(get<_i13.PlayerRemoteDataProvider>()));
  gh.lazySingleton<_i28.MyTeamBloc>(
      () => _i28.MyTeamBloc(get<_i24.IMyTeamRepository>()));
  gh.factory<_i29.PlayerBloc>(
      () => _i29.PlayerBloc(get<_i26.IPlayerRepository>()));
  return get;
}
