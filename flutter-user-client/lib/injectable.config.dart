...
import 'application/my_team/myteam_bloc.dart' as _i31;
import 'application/player/player_bloc.dart' as _i32;
...
import 'domain/my_team/i_my_team_repository.dart' as _i27;
import 'domain/player/i_player_repository.dart' as _i29;
...
import 'infrastructure/my_team/my_team_repository.dart' as _i28;
import 'infrastructure/player/player_remote_data_provider.dart' as _i16;
import 'infrastructure/player/player_repository.dart' as _i30;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i25.AuthBloc>(() => _i25.AuthBloc(get<_i10.IAuthRepository>()));
  gh.lazySingleton<_i26.EPLStatsBloc>(
      () => _i26.EPLStatsBloc(get<_i12.IEPLStatsRepository>()));
  gh.lazySingleton<_i27.IMyTeamRepository>(() => _i28.MyTeamRepository(
      get<_i14.MyTeamLocalDataProvider>(),
      get<_i15.MyTeamRemoteDataProvider>()));
  gh.lazySingleton<_i29.IPlayerRepository>(
      () => _i30.PlayerRepository(get<_i16.PlayerRemoteDataProvider>()));
  gh.lazySingleton<_i31.MyTeamBloc>(
      () => _i31.MyTeamBloc(get<_i27.IMyTeamRepository>()));
  gh.factory<_i32.PlayerBloc>(
      () => _i32.PlayerBloc(get<_i29.IPlayerRepository>()));
  return get;
}
