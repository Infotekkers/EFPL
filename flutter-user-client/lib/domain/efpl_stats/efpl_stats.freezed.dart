...
/// @nodoc
class _$EFPLStatsTearOff {
  const _$EFPLStatsTearOff();
...
/// @nodoc
const $EFPLStats = _$EFPLStatsTearOff();
...
mixin _$EFPLStats {
  ...
  @JsonKey(ignore: true)
  $EFPLStatsCopyWith<EFPLStats> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $EFPLStatsCopyWith<$Res> {
  factory $EFPLStatsCopyWith(EFPLStats value, $Res Function(EFPLStats) then) =
      _$EFPLStatsCopyWithImpl<$Res>;
  $Res call(
      {int highestPoint,
      int averagePoint,
...
/// @nodoc
class _$EFPLStatsCopyWithImpl<$Res> implements $EFPLStatsCopyWith<$Res> {
  _$EFPLStatsCopyWithImpl(this._value, this._then);

  final EFPLStats _value;
  // ignore: unused_field
  final $Res Function(EFPLStats) _then;
...
/// @nodoc
abstract class _$EFPLStatCopyWith<$Res> implements $EFPLStatsCopyWith<$Res> {
  factory _$EFPLStatCopyWith(_EFPLStat value, $Res Function(_EFPLStat) then) =
      __$EFPLStatCopyWithImpl<$Res>;
  @override
  $Res call(
      {int highestPoint,
      int averagePoint,
...
/// @nodoc
class __$EFPLStatCopyWithImpl<$Res> extends _$EFPLStatsCopyWithImpl<$Res>
    implements _$EFPLStatCopyWith<$Res> {
  __$EFPLStatCopyWithImpl(_EFPLStat _value, $Res Function(_EFPLStat) _then)
      : super(_value, (v) => _then(v as _EFPLStat));

  @override
  _EFPLStat get _value => super._value as _EFPLStat;
...
class _$_EFPLStat implements _EFPLStat {
  const _$_EFPLStat(
  ...
  @JsonKey(ignore: true)
  @override
  _$EFPLStatCopyWith<_EFPLStat> get copyWith =>
      __$EFPLStatCopyWithImpl<_EFPLStat>(this, _$identity);
}

abstract class _EFPLStat implements EFPLStats {
  const factory _EFPLStat(
      {required int highestPoint,
      required int averagePoint,
      required String mostSelectedPlayer,
      required String mostTransferredOutPlayer,
      ...
      required int wildCardCount,
      required int tripleCaptainCount,
      required Map<dynamic, dynamic> dreamTeam}) = _$_EFPLStat;
