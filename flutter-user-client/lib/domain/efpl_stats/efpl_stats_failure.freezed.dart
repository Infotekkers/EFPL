...
part of 'efpl_stats_failure.dart';
...
/// @nodoc
class _$EFPLStatsFailureTearOff {
  const _$EFPLStatsFailureTearOff();
...
/// @nodoc
const $EFPLStatsFailure = _$EFPLStatsFailureTearOff();

/// @nodoc
mixin _$EFPLStatsFailure<T> {
  ...
  @JsonKey(ignore: true)
  $EFPLStatsFailureCopyWith<T, EFPLStatsFailure<T>> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $EFPLStatsFailureCopyWith<T, $Res> {
  factory $EFPLStatsFailureCopyWith(
          EFPLStatsFailure<T> value, $Res Function(EFPLStatsFailure<T>) then) =
      _$EFPLStatsFailureCopyWithImpl<T, $Res>;
  $Res call({String failedValue});
}

/// @nodoc
class _$EFPLStatsFailureCopyWithImpl<T, $Res>
    implements $EFPLStatsFailureCopyWith<T, $Res> {
  _$EFPLStatsFailureCopyWithImpl(this._value, this._then);

  final EFPLStatsFailure<T> _value;
  // ignore: unused_field
  final $Res Function(EFPLStatsFailure<T>) _then;
...
class _$UnauthenticatedCopyWithImpl<T, $Res>
    extends _$EFPLStatsFailureCopyWithImpl<T, $Res>
...
class _$Unauthenticated<T> implements Unauthenticated<T> {
  ...
  @override
  String toString() {
    return 'EFPLStatsFailure<$T>.unauthenticated(failedValue: $failedValue)';
  }
...
abstract class Unauthenticated<T> implements EFPLStatsFailure<T> {
...
class _$Unauthorized<T> implements Unauthorized<T> {
  ...
  @override
  String toString() {
    return 'EFPLStatsFailure<$T>.unauthorized(failedValue: $failedValue)';
  }
...
abstract class Unauthorized<T> implements EFPLStatsFailure<T> {
...
class _$NoConnection<T> implements NoConnection<T> {
  ...
  @override
  String toString() {
    return 'EFPLStatsFailure<$T>.noConnection(failedValue: $failedValue)';
  }
...
abstract class NoConnection<T> implements EFPLStatsFailure<T> {
...
class _$SocketError<T> implements SocketError<T> {
  ...
  @override
  String toString() {
    return 'EFPLStatsFailure<$T>.socketError(failedValue: $failedValue)';
  }
...
abstract class SocketError<T> implements EFPLStatsFailure<T> {
...
class _$HandShakeError<T> implements HandShakeError<T> {
  ...
  @override
  String toString() {
    return 'EFPLStatsFailure<$T>.handShakeError(failedValue: $failedValue)';
  }
...
abstract class HandShakeError<T> implements EFPLStatsFailure<T> {
...
class _$UnexpectedError<T> implements UnexpectedError<T> {
  ...
  @override
  String toString() {
    return 'EFPLStatsFailure<$T>.unexpectedError(failedValue: $failedValue)';
  }
...
abstract class UnexpectedError<T> implements EFPLStatsFailure<T> {
