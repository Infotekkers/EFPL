...
/// @nodoc
class _$PointFailureTearOff {
  const _$PointFailureTearOff();
...
/// @nodoc
const $PointFailure = _$PointFailureTearOff();

/// @nodoc
mixin _$PointFailure<T> {
  ...
  @JsonKey(ignore: true)
  $PointFailureCopyWith<T, PointFailure<T>> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PointFailureCopyWith<T, $Res> {
  factory $PointFailureCopyWith(
          PointFailure<T> value, $Res Function(PointFailure<T>) then) =
      _$PointFailureCopyWithImpl<T, $Res>;
  $Res call({String failedValue});
}

/// @nodoc
class _$PointFailureCopyWithImpl<T, $Res>
    implements $PointFailureCopyWith<T, $Res> {
  _$PointFailureCopyWithImpl(this._value, this._then);

  final PointFailure<T> _value;
  // ignore: unused_field
  final $Res Function(PointFailure<T>) _then;
...
class _$NoTeamSelectedCopyWithImpl<T, $Res>
    extends _$PointFailureCopyWithImpl<T, $Res>
...
class _$NoTeamSelected<T> implements NoTeamSelected<T> {
  ...
  @override
  String toString() {
    return 'PointFailure<$T>.noTeamSelected(failedValue: $failedValue)';
  }
...
abstract class NoTeamSelected<T> implements PointFailure<T> {
...
class _$IncompleteTeam<T> implements IncompleteTeam<T> {
  ...
  @override
  String toString() {
    return 'PointFailure<$T>.incompleteTeam(failedValue: $failedValue)';
  }
...
abstract class IncompleteTeam<T> implements PointFailure<T> {
...
class _$Unauthenticated<T> implements Unauthenticated<T> {
  ...
  @override
  String toString() {
    return 'PointFailure<$T>.unauthenticated(failedValue: $failedValue)';
  }
...
abstract class Unauthenticated<T> implements PointFailure<T> {
...
class _$Unauthorized<T> implements Unauthorized<T> {
  ...
  @override
  String toString() {
    return 'PointFailure<$T>.unauthorized(failedValue: $failedValue)';
  }
...
abstract class Unauthorized<T> implements PointFailure<T> {
...
class _$NoConnection<T> implements NoConnection<T> {
  ...
  @override
  String toString() {
    return 'PointFailure<$T>.noConnection(failedValue: $failedValue)';
  }
...
abstract class NoConnection<T> implements PointFailure<T> {
...
class _$SocketError<T> implements SocketError<T> {
  ...
  @override
  String toString() {
    return 'PointFailure<$T>.socketError(failedValue: $failedValue)';
  }
...
abstract class SocketError<T> implements PointFailure<T> {
...
class _$HandShakeError<T> implements HandShakeError<T> {
  ...
  @override
  String toString() {
    return 'PointFailure<$T>.handShakeError(failedValue: $failedValue)';
  }
...
abstract class HandShakeError<T> implements PointFailure<T> {
...
class _$UnexpectedError<T> implements UnexpectedError<T> {
  ...
  @override
  String toString() {
    return 'PointFailure<$T>.unexpectedError(failedValue: $failedValue)';
  }
...
abstract class UnexpectedError<T> implements PointFailure<T> {
...
class _$HiveError<T> implements HiveError<T> {
  ...
  @override
  String toString() {
    return 'PointFailure<$T>.hiveError(failedValue: $failedValue)';
  }
...
abstract class HiveError<T> implements PointFailure<T> {
...
class _$SharedPreferencesError<T> implements SharedPreferencesError<T> {
  ...
  @override
  String toString() {
    return 'PointFailure<$T>.sharedPreferencesError(failedValue: $failedValue)';
  }
...
abstract class SharedPreferencesError<T> implements PointFailure<T> {
...
class _$SecureStorageError<T> implements SecureStorageError<T> {
  ...
  @override
  String toString() {
    return 'PointFailure<$T>.secureStorageError(failedValue: $failedValue)';
  }
...
abstract class SecureStorageError<T> implements PointFailure<T> {
