...
part of 'point_user_player.dart';
...
/// @nodoc
class _$PointUserPlayerTearOff {
  const _$PointUserPlayerTearOff();

  _PointUserPlayer call(
...
/// @nodoc
const $PointUserPlayer = _$PointUserPlayerTearOff();

/// @nodoc
mixin _$PointUserPlayer {
  ...
  @JsonKey(ignore: true)
  $PointUserPlayerCopyWith<PointUserPlayer> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PointUserPlayerCopyWith<$Res> {
  factory $PointUserPlayerCopyWith(
          PointUserPlayer value, $Res Function(PointUserPlayer) then) =
      _$PointUserPlayerCopyWithImpl<$Res>;
  $Res call(
      {String playerId,
      PlayerName playerName,
      PlayerPosition playerPosition,
...
/// @nodoc
class _$PointUserPlayerCopyWithImpl<$Res>
    implements $PointUserPlayerCopyWith<$Res> {
  _$PointUserPlayerCopyWithImpl(this._value, this._then);

  final PointUserPlayer _value;
  // ignore: unused_field
  final $Res Function(PointUserPlayer) _then;
...
/// @nodoc
abstract class _$PointUserPlayerCopyWith<$Res>
    implements $PointUserPlayerCopyWith<$Res> {
  factory _$PointUserPlayerCopyWith(
          _PointUserPlayer value, $Res Function(_PointUserPlayer) then) =
      __$PointUserPlayerCopyWithImpl<$Res>;
  @override
  $Res call(
      {String playerId,
      PlayerName playerName,
...
/// @nodoc
class __$PointUserPlayerCopyWithImpl<$Res>
    extends _$PointUserPlayerCopyWithImpl<$Res>
    implements _$PointUserPlayerCopyWith<$Res> {
  __$PointUserPlayerCopyWithImpl(
      _PointUserPlayer _value, $Res Function(_PointUserPlayer) _then)
      : super(_value, (v) => _then(v as _PointUserPlayer));

  @override
  _PointUserPlayer get _value => super._value as _PointUserPlayer;
...
class _$_PointUserPlayer implements _PointUserPlayer {
  const _$_PointUserPlayer(
  ...
  @override
  String toString() {
    return 'PointUserPlayer(playerId: $playerId, playerName: $playerName, playerPosition: $playerPosition, eplTeamId: $eplTeamId, multiplier: $multiplier, isCaptain: $isCaptain, isViceCaptain: $isViceCaptain, score: $score, fixtureStatus: $fixtureStatus, fixtureScore: $fixtureScore, fixtureTeams: $fixtureTeams)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$PointUserPlayerCopyWith<_PointUserPlayer> get copyWith =>
      __$PointUserPlayerCopyWithImpl<_PointUserPlayer>(this, _$identity);
}

abstract class _PointUserPlayer implements PointUserPlayer {
  const factory _PointUserPlayer(
      {required String playerId,
      required PlayerName playerName,
      required PlayerPosition playerPosition,
      required PlayerEplTeam eplTeamId,
      ...
      required String fixtureStatus,
      required String fixtureScore,
      required String fixtureTeams}) = _$_PointUserPlayer;
