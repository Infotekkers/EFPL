...
part of 'watch_list_player.dart';
...
/// @nodoc
class _$WatchListPlayerTearOff {
  const _$WatchListPlayerTearOff();

  _WatchListPlayer call(
...
/// @nodoc
const $WatchListPlayer = _$WatchListPlayerTearOff();

/// @nodoc
mixin _$WatchListPlayer {
  String get playerId => throw _privateConstructorUsedError;
  PlayerName get playerName => throw _privateConstructorUsedError;
  PlayerPrice get currentPrice => throw _privateConstructorUsedError;
  PlayerPosition get playerPosition => throw _privateConstructorUsedError;
  PlayerEplTeam get eplTeamId => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $WatchListPlayerCopyWith<WatchListPlayer> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WatchListPlayerCopyWith<$Res> {
  factory $WatchListPlayerCopyWith(
          WatchListPlayer value, $Res Function(WatchListPlayer) then) =
      _$WatchListPlayerCopyWithImpl<$Res>;
  $Res call(
      {String playerId,
      PlayerName playerName,
...
/// @nodoc
class _$WatchListPlayerCopyWithImpl<$Res>
    implements $WatchListPlayerCopyWith<$Res> {
  _$WatchListPlayerCopyWithImpl(this._value, this._then);

  final WatchListPlayer _value;
  // ignore: unused_field
  final $Res Function(WatchListPlayer) _then;
...
/// @nodoc
abstract class _$WatchListPlayerCopyWith<$Res>
    implements $WatchListPlayerCopyWith<$Res> {
  factory _$WatchListPlayerCopyWith(
          _WatchListPlayer value, $Res Function(_WatchListPlayer) then) =
      __$WatchListPlayerCopyWithImpl<$Res>;
  @override
  $Res call(
      {String playerId,
      PlayerName playerName,
...
/// @nodoc
class __$WatchListPlayerCopyWithImpl<$Res>
    extends _$WatchListPlayerCopyWithImpl<$Res>
    implements _$WatchListPlayerCopyWith<$Res> {
  __$WatchListPlayerCopyWithImpl(
      _WatchListPlayer _value, $Res Function(_WatchListPlayer) _then)
      : super(_value, (v) => _then(v as _WatchListPlayer));

  @override
  _WatchListPlayer get _value => super._value as _WatchListPlayer;
...
class _$_WatchListPlayer implements _WatchListPlayer {
  const _$_WatchListPlayer(
  ...
  @override
  final PlayerPrice currentPrice;
  @override
  final PlayerPosition playerPosition;
  @override
  final PlayerEplTeam eplTeamId;
  @override
  ...
  @override
  String toString() {
    return 'WatchListPlayer(playerId: $playerId, playerName: $playerName, currentPrice: $currentPrice, playerPosition: $playerPosition, eplTeamId: $eplTeamId, eplTeamLogo: $eplTeamLogo, availability: $availability, score: $score, upComingFixtures: $upComingFixtures)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$WatchListPlayerCopyWith<_WatchListPlayer> get copyWith =>
      __$WatchListPlayerCopyWithImpl<_WatchListPlayer>(this, _$identity);
}

abstract class _WatchListPlayer implements WatchListPlayer {
  const factory _WatchListPlayer(
      {required String playerId,
      required PlayerName playerName,
      required PlayerPrice currentPrice,
      required PlayerPosition playerPosition,
      ...
      required PlayerAvailability availability,
      required int score,
      required List<dynamic> upComingFixtures}) = _$_WatchListPlayer;
  ...
  @override
  PlayerPrice get currentPrice;
  @override
  PlayerPosition get playerPosition;
  @override
  PlayerEplTeam get eplTeamId;
  @override
