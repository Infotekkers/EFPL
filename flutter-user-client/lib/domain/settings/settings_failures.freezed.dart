...
part of 'settings_failures.dart';
...
abstract class _ServerError implements SettingsFailure {
...
class _$_LocalDBError implements _LocalDBError {
  ...
  @override
  String toString() {
    return 'SettingsFailure.localDBError()';
  }
...
abstract class _LocalDBError implements SettingsFailure {
...
class _$_NetworkError implements _NetworkError {
  ...
  @override
  String toString() {
    return 'SettingsFailure.networkError()';
  }
...
abstract class _NetworkError implements SettingsFailure {
